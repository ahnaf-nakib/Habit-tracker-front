              ...
              {habits.map((h) => (
                <tr key={h._id} className="hover:bg-gray-700 transition">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-yellow-500 font-semibold">
                    {h.currentStreak || h.completionHistory?.length || 0}
                  </td>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-center flex justify-center space-x-3">
                    ...
                    <button
                      ...
                      title="Mark Complete"
                      className="flex items-center justify-center w-10 h-10 bg-green-600 hover:bg-green-700 rounded-full transition shadow-md hover:scale-105"
                    >
                    ...
                    {/* Edit */}
                    <Link
                      to={`/update-habit/${h._id}`}
                      title="Edit Habit"
                      className="flex items-center justify-center w-10 h-10 bg-indigo-600 hover:bg-indigo-700 rounded-full transition shadow-md hover:scale-105"
                    >
                    ...
                    {/* Delete */}
                    <button
                      onClick={() => setConfirmDeleteId(h._id)}
                      title="Delete Habit"
                      className="flex items-center justify-center w-10 h-10 bg-red-600 hover:bg-red-700 rounded-full transition shadow-md hover:scale-105"
                    >
