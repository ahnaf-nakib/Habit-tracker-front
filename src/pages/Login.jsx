...
function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // NOTE: Update local storage based on user state in App.js's useEffect
            toast.success("Login successful! Redirecting...");
            navigate("/my-habits"); // Redirect to a protected page after login
        } catch (error) {
    ...
    const handleGoogle = async () => {
        try {
            ...
            // Save user info to localStorage (as done in Signup.jsx)
            const userData = {
                uid: user.uid,
            ...
            navigate("/my-habits"); // Redirect after Google login
        } catch (err) {
        ...
        <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
            <div className="w-full max-w-md bg-gray-800 rounded-xl shadow-2xl p-8 space-y-6 border border-indigo-900/50">
                ...
                <p className="text-center text-sm text-gray-400 pt-2">
                    ...
                    <Link to="/signup" className="text-indigo-400 hover:text-indigo-300 font-medium ml-1 transition duration-150">
                        Register here
                    </Link>
                </p>
            </div>
